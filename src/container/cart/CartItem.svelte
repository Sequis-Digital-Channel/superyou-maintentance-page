...
<div class="cart-item bg-white rounded-xl w-full relative">
  <div class="p-3 cart-item-grid">
    <div class="item-icon pt-1">
      <img
        src="https://superyou.co.id//img/icons/product-with-badge/super-safe-silver.svg"
      ...
      <div class="item-meta-wrapper flex flex-col">
        ...
        <span
          ...
          <svg
            ...
            role="img"
            focusable="false"
            style="display: block; fill: none; height: 10px; width: 10px; stroke: #0d294a; stroke-width: 4; overflow: visible;"><g
              fill="none">
              <path
              ...
              <div
                ...
                <div
                  ...
                  <svg
                    ...
                    role="img"
                    focusable="false"
                    style="display: block; fill: none; height: 12px; width: 12px; stroke: #0d294a; stroke-width: 4; overflow: visible;"><g
                      fill="none">
                      <path
                        d="m28 12-11.2928932 11.2928932c-.3905243.3905243-1.0236893.3905243-1.4142136 0l-11.2928932-11.2928932" />
                    </g></svg>
