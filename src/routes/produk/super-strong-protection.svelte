<script context="module">
  ...
  <script>
    ...
    onMount(() => {
      ...
      if ("IntersectionObserver" in window) {
        ...
        const otherProd = document.querySelector(".otherproduct-strong");
    ...
    <AboveTheFold meta={heroMeta}>
      <picture class="hero-strong" slot="hero-img">
        <source
          ...
          srcset="https://ik.imagekit.io/oc2o82pyjsh/superyou/super-strong/hero-super-strong_Ev6yYC6m4A8.png?tr=q-70"
        >
        <source
          media="(max-width: 500px)"
          srcset="https://ik.imagekit.io/oc2o82pyjsh/superyou/super-strong/hero-super-strong_Ev6yYC6m4A8.png?tr=q-30"
        >
        <img
          src="https://ik.imagekit.io/oc2o82pyjsh/superyou/super-strong/hero-super-strong_Ev6yYC6m4A8.png?tr=q-70"
  ...
  <section class="su_container otherproduct-strong" style="background-color:#e7eaef;">
  ...
  <style lang="postcss">
    ...
    .su_container.otherproduct-strong 
    {
