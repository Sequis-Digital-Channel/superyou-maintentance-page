export const superCareNotCovered = [
  {
    icon: '/icons/products/care/notcovered/crash.svg',
    description: 'Santunan kematian selain karena penyakit menular, serta santunan cacat total & tetap'
  },
  {
    icon: '/icons/products/care/notcovered/critical-illness.svg',
    description: 'Santunan rawat inap selain untuk penyakit menular dan kecelakaan'
  },
  {
    icon: '/icons/products/care/notcovered/shape.svg',
